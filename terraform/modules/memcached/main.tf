resource "aws_elasticache_cluster" "memcached" {
  cluster_id           = "${var.memcached_cluster_prefix}-${var.environment}"
  engine               = "memcached"
